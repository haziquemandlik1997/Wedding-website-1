...
const GalleryPage = ({ guestCode, setCurrentPage, setLoginRedirectPath, isAdmin }) => {
    ...
    const handleFileChange = async (e) => {
        ...
        try {
            ...
            xhrRef.current.open('PUT', uploadUrl, true);
            xhrRef.current.upload.onprogress = (event) => setUploadProgress(Math.round((event.loaded / event.total) * 100));
            xhrRef.current.onload = async () => {
